...
export function TopNav() {
  return (
    <header className="fixed left-0 right-0 top-0 z-30 h-[76px] border-b border-momo-border/70 bg-white/95 backdrop-blur lg:left-[260px]">
      <div className="flex h-full min-w-0 items-center gap-6 px-4 md:px-7 lg:px-8">
        <nav
          aria-label="MoMo"
        ...
        <div className="min-w-0 lg:hidden">
          <p className="text-sm font-bold text-momo-text">SpendSnap Student</p>
        ...
        <div className="ml-auto flex shrink-0 items-center gap-3">
          ...
          <button
            ...
            className="relative grid h-10 w-10 shrink-0 place-items-center rounded-[14px] border border-slate-200 bg-white text-slate-500 transition duration-200 hover:border-momo-border hover:bg-momo-soft hover:text-momo-primary"
            type="button"
          >
          ...
          <button
            className="flex h-10 w-[204px] shrink-0 items-center gap-2 rounded-[14px] border border-slate-200 bg-white py-1 pl-1 pr-2 transition duration-200 hover:border-momo-border hover:bg-momo-soft"
            type="button"
          >
